    ...
    <main className="min-h-screen bg-white text-gray-800 px-6 py-16">
      <section className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { name: 'Santosh Sharma', role: 'Founder & CEO', img: '/images/team1.jpg' },
            { name: 'Shriyan Sapkota', role: 'CTO', img: '/images/team2.jpg' },
            { name: 'Jessica Gurung', role: 'CFO', img: '/images/team3.jpg' },
            { name: 'Sanjeev Sharma', role: 'CMO', img: '/images/team4.jpg' },
          ].map((member, i) => (
