          ...
          >
            ...
            <div className="px-4 pb-4 flex justify-between items-center">
              <Link
                ...
                className="bg-purple-700 text-sm text-white px-4 py-2 rounded hover:bg-purple-800 transition-colors"
              >
                Edit
              </Link>
              <button
                onClick={() => deleteProduct(product._id)}
                className="bg-indigo-600 text-sm text-white px-4 py-2 rounded hover:bg-indigo-700 transition-colors"
              >
                Delete
              </button>
            </div>
