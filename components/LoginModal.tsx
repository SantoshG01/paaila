      ...
      {isLoginOpen && (
        ...
        >
          &times;
            ...
            <h2 className="text-2xl font-bold text-center text-gray-900 mb-6">Login to Paaila Nepal</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-1/2 right-3 -translate-y-1/2 text-indigo-700 hover:text-indigo-800 transition"
              ...
              <div className="flex justify-between items-center gap-4">
                <button
                  type="submit"
                  className="flex-1 py-2 bg-purple-700 text-white font-semibold rounded hover:bg-purple-800 transition duration-200"
                >
                  Login
                </button>
                {/* <button
