                ...
                <div className="px-4 py-3 flex flex-col gap-2 flex-grow bg-gray-100">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      ...
                      className="w-1/2 bg-purple-700 hover:bg-purple-800 text-white py-2 rounded flex items-center justify-center gap-1 text-sm font-medium shadow"
                    >
                    ...
                    <Link
                      ...
                      className="w-1/2 bg-indigo-600 hover:bg-indigo-800 text-white py-2 rounded flex items-center justify-center gap-1 text-sm font-medium border border-gray-300 shadow"
                    >
                      Shop
                    </Link>
                  </div>
